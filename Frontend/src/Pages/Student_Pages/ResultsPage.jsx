            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                ...
                <div className="ml-6">
                  ...
                  <div className="mt-4">
                    <span className="text-2xl font-bold text-purple-400">Grade: {quizResults.grade}</span>
                  </div>
                </div>
              </div>
            </motion.div>
                      ...
                      >
                        <div className="space-y-2">
                          <p className="text-gray-400">
                            Your Answer: <span className={question.isCorrect ? "text-green-400" : "text-red-400"}>
                              {question.userAnswer}
                            </span>
                          </p>
                          {!question.isCorrect && (
